...
class LiteralValue implements Mithril
{
    ...
    private function rollDice() {
      ...
      M.request({
        ...
        data: {type: "LITERAL_VALUE", payload: {"rollValue": rollValue}},
    ...
    public function view() [
      m('div', {"class": "card center-align"}, [
        m('h3', {"class": ""}, "Literal Value"),
        m('h6', {"class": ""}, "Where X​ is any positive number, eg: 2 (result is always 2). (Accepted Values [1-8]) - Example '6'"),
