...
class ExplosiveRoll implements Mithril
{
    ...
    private function rollDice() {
      ...
      M.request({
        ...
        data: {type: "EXPLOSIVE_ROLL", payload: {"rollValue": rollValue}},
    ...
    public function view() [
      m('div', {"class": "card center-align"}, [
        m('h3', {"class": ""}, "Explosive Roll"),
        m('h6', {"class": ""}, "For each value that is equal or greater than E​ roll again until no values
