...
class KeepHighestRolls implements Mithril
{
    ...
    private function rollDice() {
      ...
      M.request({
        ...
        data: {type: "KEEP_HIGHEST_ROLLS", payload: {"rollValue": rollValue}},
    ...
    public function view() [
      m('div', {"class": "card center-align"}, [
        m('h3', {"class": ""}, "Keep Highest Rolls"),
        m('h6', {"class": ""}, "Keep the highest rolls (Accepted Values [1-∞]d[1-8]k[1-8] - Example '10d6k4'"),
